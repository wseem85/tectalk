  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="2"
        d="M12 4v4m6.364 1.636l-2.828 2.829M20 12h-4m-1.636 6.364l-2.828-2.829M12 20v-4m-6.364-1.636l2.829-2.828M4 12h4m1.636-6.364l2.829 2.828"
      />
    </svg>
  );
}
export default function LoginGithubButton() {
  ...
  return (
    <form action={formAction}>
      <button className=" flex gap-2 items-center text-base ml-auto text  mr-auto bg-transparent underline text-pink-700 hover:text-pink-600">
        {pending ? (
          <>
            Signing in <GithubSpinner />
          </>
        ) : (
          <>
            Log in with Github
